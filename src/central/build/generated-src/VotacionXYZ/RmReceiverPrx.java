...
{
    default void receiveMessage(Message m, AckServicePrx ack)
    {
        receiveMessage(m, ack, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void receiveMessage(Message m, AckServicePrx ack, java.util.Map<String, String> context)
    {
        _iceI_receiveMessageAsync(m, ack, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> receiveMessageAsync(Message m, AckServicePrx ack)
    {
        return _iceI_receiveMessageAsync(m, ack, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> receiveMessageAsync(Message m, AckServicePrx ack, java.util.Map<String, String> context)
    {
        return _iceI_receiveMessageAsync(m, ack, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_receiveMessageAsync(Message iceP_m, AckServicePrx iceP_ack, java.util.Map<String, String> context, boolean sync)
    {
