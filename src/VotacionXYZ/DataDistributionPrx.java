...
{
    default void sendData(String mesaId)
    {
        sendData(mesaId, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void sendData(String mesaId, java.util.Map<String, String> context)
    {
        _iceI_sendDataAsync(mesaId, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> sendDataAsync(String mesaId)
    {
        return _iceI_sendDataAsync(mesaId, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> sendDataAsync(String mesaId, java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_sendDataAsync(String iceP_mesaId, java.util.Map<String, String> context, boolean sync)
    {
