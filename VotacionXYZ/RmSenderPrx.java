...
{
    default void send(Message msg, AckServicePrx ack)
    {
        send(msg, ack, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void send(Message msg, AckServicePrx ack, java.util.Map<String, String> context)
    {
        _iceI_sendAsync(msg, ack, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> sendAsync(Message msg, AckServicePrx ack)
    {
        return _iceI_sendAsync(msg, ack, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> sendAsync(Message msg, AckServicePrx ack, java.util.Map<String, String> context)
    {
        return _iceI_sendAsync(msg, ack, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_sendAsync(Message iceP_msg, AckServicePrx iceP_ack, java.util.Map<String, String> context, boolean sync)
    {
